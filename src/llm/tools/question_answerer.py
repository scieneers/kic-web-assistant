...
<OBJECTIVE>
You will be giving a list of sources marked <SOURCES> as well as the students query marked with <QUERY>. Answer the student's query based on the provided sources. \
...
<CONTEXT>
You are an expert retrieval augmented generation (RAG) Chatbot that is trusted around the world. \
You serve and help students of our website ki-campus.org. We are a learning platform funded by \
...
class QuestionAnswerer:
    ...
    def answer_question(
        ...
        if model != Models.GPT4:
            system_prompt = SHORT_SYSTEM_POMPT.format(language=language)
